...
<body>
    ...
    <main class="app-wrapper">
        <div class="container-fluid">
            <div class="d-flex align-items-center mt-2 mb-2">
                <h6 class="mb-0 flex-grow-1">Historial</h6>
                <div class="flex-shrink-0">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-end mb-0">
                            <li class="breadcrumb-item">Panel de administrador</a></li>
            ...
            <div class="row">
                        ...
                        <div class="card-header d-flex">
                            <form method="GET" action="" class="d-flex w-100">
                                ...
                                <div class="col-md-4 col-xl-6 col-xxl-8 text-end">
                                    <a href="apps-project-create.php">
                                        <button type="button" class="btn btn-light-info"><i class="bi bi-plus-circle-dotted me-2"></i>Crear Ticket</button>
                                    </a>
                                </div>
                            </form>
                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo isset($ticket['fecha_solucion']) ? date('d/m/Y', strtotime($ticket['fecha_solucion'])) : 'Pendiente'; ?>
                                                    <td>
                                                        ...
                                                        <?php if($ticket['asignado'] === null): ?>
                                                        <button type="button" class="btn btn-light-info" data-bs-toggle="modal" data-bs-target="#Asignar" data-ticket-id="<?php echo $ticket['id_ticket']; ?>">
                ...
                <div class="modal fade" id="Asignar" data-bs-keyboard="false" tabindex="-1" aria-labelledby="Asignar" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="Asignar">Asignar ticket</h5>
                                <button type="button" class="btn-close icon-btn-sm" data-bs-dismiss="modal" aria-label="Close">
                                    <i class="ri-close-large-line fw-semibold"></i>
                                </button>
                            </div>
                            <div class="modal-body">
                                <form method="POST" action="Asignar_ticket.php">
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        if (msg === 'ticket_asignado') {
            Swal.fire({
                icon: 'success',
                title: 'Ticket asignado',
                text: 'Se ha asignado el ticket al agente correctamente.',
                timer: 2000,
                showConfirmButton: false,
            });
        } else if (msg === 'error_asignar') {
            Swal.fire({ icon: 'error', title: 'Error al asignar ticket', text: 'Se ha producido un error al asignar el ticket. Inténtalo nuevamente' });
        }
    });
    ...
    <script>
    document.addEventListener('DOMContentLoaded', function() {
        var asignarModal = document.getElementById('Asignar');
        if (asignarModal) {
            asignarModal.addEventListener('show.bs.modal', function(event) {
                var button = event.relatedTarget;
                var ticketId = button.getAttribute('data-ticket-id');
                var ticketIdInput = asignarModal.querySelector('#ticket_id');
