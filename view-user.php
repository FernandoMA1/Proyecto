...
<body>
        ...
        <div class="container" style="max-width: 1200px;">
            <div class="card shadow-sm border-0" style="border-radius: 12px;">
                <div class="card-header bg-light d-flex justify-content-between align-items-center" style="border-radius: 12px 12px 0 0;">
                    ...
                    <a href="listadeusuarios.php" class="btn btn-dark btn-sm">
                    ...
                    <form method="POST">
                        <div class="row g-5">
                            ...
                            <div class="col-xl-12">
                                ...
                                <input type="text" class="form-control" id="apellidos" name="apellidos" placeholder="Ingresa los apellidos" value="<?= $usuario['apellidos']; ?>" required>
                            </div>
                            <div class="col-12">
                                <label for="email" class="form-label">Email</label>
                                <input type="text" class="form-control" id="email" name="email" placeholder="Ingresa el email" value="<?= $usuario['email']; ?>" required>
                            </div>
                            <div class="col-12">
                                <label for="telefono" class="form-label">Teléfono</label>
                                <input type="text" class="form-control" id="telefono" name="telefono" placeholder="Ingresa el telefono" value="<?= $usuario['telefono']; ?>" required>
                            </div>
                            <div class="col-xl-6">
                            ...
                            <div class="col-xl-6">
                                <label for="estatus" class="form-label">Estatus de usuario</label>
                                <select class="form-select" id="estatus" name="estatus" required>
                                    <option value="Disponible" <?= $usuario['estatus_usuario'] === 'Disponible' ? 'selected' : '' ?>>Disponible</option>
                                    <option value="No Disponible" <?= $usuario['estatus_usuario'] === 'No Disponible' ? 'selected' : '' ?>>No Disponible</option>
                                </select>
                            </div>
                            <div class="mb-8 d-flex justify-content-end gap-3">
                                <button type="submit" class="btn btn-light-info" id="btnGuardarUser">
                                    <span class="spinner-border spinner-border-sm me-2 d-none" id="spinnerUser"></span>Guardar cambios
                                </button>
                            </div>
                        </div>
                    </form>
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        const btnEnviar = document.getElementById('btnGuardarUser');
        const spinner = document.getElementById('spinnerUser');
